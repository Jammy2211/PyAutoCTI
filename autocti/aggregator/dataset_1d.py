...
def _dataset_1d_list_from(
    fit: af.Fit, settings_dataset: Optional[SettingsDataset1D] = None
):
    """
    ...
    return [
        dataset.apply_settings(settings=settings_dataset) for dataset in dataset_list
    ]
...
class Dataset1DAgg:
    ...
    def dataset_list_gen_from(
        self, settings_dataset: Optional[SettingsDataset1D] = None
    ):
        """
        ...
        func = partial(_dataset_1d_list_from, settings_dataset=settings_dataset)
