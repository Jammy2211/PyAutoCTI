...
def plot_image_line(
        fit, stack_axis, mask=None, as_subplot=False,
        figsize=(7, 7),
    ...
    line_plotters.plot_line_from_array(
        array=fit.image, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_noise_map_line(
    ...
    """
    line_plotters.plot_line_from_array(
        array=fit.noise_map, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_signal_to_noise_map_line(
    ...
    """
    line_plotters.plot_line_from_array(
        array=fit.signal_to_noise_map, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_ci_pre_cti_line(
    ...
    """
    line_plotters.plot_line_from_array(
        array=fit.ci_pre_cti, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_ci_post_cti_line(
    ...
    """
    line_plotters.plot_line_from_array(
        array=fit.ci_post_cti, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_residual_map_line(
    ...
    """
    line_plotters.plot_line_from_array(
        array=fit.residual_map, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_chi_squared_map_line(
    ...
    """
    line_plotters.plot_line_from_array(
        array=fit.chi_squared_map, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)