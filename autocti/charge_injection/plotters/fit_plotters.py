...
def plot_image_stack(
        fit, stack_region, mask=None, as_subplot=False,
        figsize=(7, 7),
        title='Image', titlesize=16, xlabelsize=16, ylabelsize=16, xyticksize=16,
        output_path=None, output_format='show', output_filename='fit_image_stack'):
    """Plot the observed image of the ccd data.
    ...
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.image, stack_region=stack_region, ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_noise_map_stack(
        ...
        output_path=None, output_format='show', output_filename='fit_noise_map_stack'):
    """Plot the observed noise_map of the ccd data.
    ...
    """
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.noise_map, stack_region=stack_region, ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_signal_to_noise_map_stack(
        ...
        output_path=None, output_format='show', output_filename='fit_signal_to_noise_map_stack'):
    """Plot the observed signal_to_noise_map of the ccd data.
    ...
    """
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.signal_to_noise_map, stack_region=stack_region,  ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_ci_pre_cti_stack(
        ...
        output_path=None, output_format='show', output_filename='fit_ci_pre_cti_stack'):
    """Plot the observed ci_pre_cti of the ccd data.
    ...
    """
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.ci_pre_cti, stack_region=stack_region,  ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
    
    
def plot_ci_post_cti_stack(
        fit, stack_region, mask=None, as_subplot=False,
        figsize=(7, 7),
        title='CI Post-CTI Image', titlesize=16, xlabelsize=16, ylabelsize=16, xyticksize=16,
        output_path=None, output_format='show', output_filename='fit_ci_post_cti_stack'):
    """Plot the observed ci_post_cti of the ccd data.
    ...
    """
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.ci_post_cti, stack_region=stack_region, ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
    
    
def plot_residual_map_stack(
        fit, stack_region, mask=None, as_subplot=False,
        figsize=(7, 7),
        title='Residual Map', titlesize=16, xlabelsize=16, ylabelsize=16, xyticksize=16,
        output_path=None, output_format='show', output_filename='fit_residual_map_stack'):
    """Plot the observed residual_map of the ccd data.
    ...
    """
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.residual_map, stack_region=stack_region, ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
    
    
def plot_chi_squared_map_stack(
        fit, stack_region, mask=None, as_subplot=False,
        figsize=(7, 7),
        title='Chi-Squared Map', titlesize=16, xlabelsize=16, ylabelsize=16, xyticksize=16,
        output_path=None, output_format='show', output_filename='fit_chi_squared_map_stack'):
    """Plot the observed chi_squared_map of the ccd data.
    ...
    """
    stack_plotters.plot_extracted_stack_from_array_ci_frame_and_stack_region(
        array=fit.chi_squared_map, stack_region=stack_region, ci_frame=fit.ci_data_fit.ci_frame, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)