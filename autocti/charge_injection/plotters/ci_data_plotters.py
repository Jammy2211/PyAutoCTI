...
def plot_ci_data_line_individual(ci_data, stack_axis, mask=None,
                                    should_plot_image=False,
                                    should_plot_noise_map=False,
                                    should_plot_ci_pre_cti=False,
                                    should_plot_signal_to_noise_map=False,
    ...
    if should_plot_image:
        plot_image_line(ci_data=ci_data, stack_axis=stack_axis, mask=mask,
                        output_path=output_path, output_format=output_format)

    if should_plot_noise_map:
        plot_noise_map_line(ci_data=ci_data, stack_axis=stack_axis, mask=mask,
                       output_path=output_path, output_format=output_format)

    if should_plot_ci_pre_cti:
        plot_ci_pre_cti_line(ci_data=ci_data, stack_axis=stack_axis, mask=mask,
                        output_path=output_path, output_format=output_format)

    if should_plot_signal_to_noise_map:
        plot_signal_to_noise_map_line(ci_data=ci_data, stack_axis=stack_axis, mask=mask,
                                 output_path=output_path, output_format=output_format)
...
def plot_image_line(
    ...
    data_plotters.plot_image_line(
        image=ci_data.image, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_noise_map_line(
    ...
    data_plotters.plot_noise_map_line(
        noise_map=ci_data.noise_map, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_ci_pre_cti_line(
    ...
    data_plotters.plot_ci_pre_cti_line(
        ci_pre_cti=ci_data.ci_pre_cti, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)
...
def plot_signal_to_noise_map_line(
    ...
    data_plotters.plot_signal_to_noise_map_line(
        signal_to_noise_map=ci_data.signal_to_noise_map, stack_axis=stack_axis, mask=mask, as_subplot=as_subplot,
       figsize=figsize,
       title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
       output_path=output_path, output_format=output_format, output_filename=output_filename)