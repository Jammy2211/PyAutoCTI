...
from autocti.autofit import link
...
class Result(object):
    ...
    def __init__(self, constant, likelihood, variable=None):
        ...
        variable: mm.ModelMapper
            An object comprising priors determined by this stage of the ctiing
        """
...
class NonLinearOptimizer(object):
    ...
    def __init__(self, model_mapper=None, name=None, label_config=None, **classes):
        ...
        ------------
        path : str
            The path where the non-linear ctiing nlo are stored.
        obj_name : str
...
class DownhillSimplex(NonLinearOptimizer):
    ...
    def __init__(self, model_mapper=None,
        ...
        super(DownhillSimplex, self).__init__(model_mapper=model_mapper, name=name, label_config=label_config)
...
class MultiNest(NonLinearOptimizer):
    ...
    def __init__(self, model_mapper=None, sigma_limit=3, run=pymultinest.run, name=None, label_config=None):
        """Class to setup and run a MultiNest ctiing and output the MultiNest nlo.
        ...
        super(MultiNest, self).__init__(model_mapper=model_mapper, name=name, label_config=label_config)
