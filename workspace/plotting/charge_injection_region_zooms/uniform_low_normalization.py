...
serial_species = arctic_params.Species(trap_density=80.0, trap_lifetime=4.0)
...
ci_data_plotters.plot_image(ci_data=ci_datas[0], cmap='cool', ylabelsize=0,
                          ...
                          cb_tick_values=[min_value, 1.0, 5.0, 20.0, max_value],
                          cb_tick_labels=['{0:.1f}'.format(min_value), '1.0', '5.0', '20.0','100.0'])

# Now, lets output this simulated ccd-data to the data folder. First, we'll get a relative path.
path = '{}/'.format(os.path.dirname(os.path.realpath(__file__)))

ci_plot_path = path + '/plots/uniform_low_normalization/'
...
ci_data_plotters.plot_image(ci_data=ci_datas[0], cmap='cool', ylabelsize=0,
                            norm='symmetric_log', linthresh=1.0, linscale=0.02,
                            cb_tick_values=[min_value, 1.0, 5.0, 20.0, max_value],
                            cb_tick_labels=['{0:.1f}'.format(min_value), '1.0', '5.0', '20.0', '100.0'],
