...
ci_data_name = 'ci_x8_images_non_uniform'
ci_data_resolution = 'low_res' # The resolution of the image.
ci_data_model = 'serial_x3_species_model_7'
...
# serial_species_0 = arctic_params.Species(trap_density=0.31, trap_lifetime=0.8)
# serial_species_1 = arctic_params.Species(trap_density=0.31, trap_lifetime=4.0)
# serial_species_2 = arctic_params.Species(trap_density=0.01, trap_lifetime=20.0)
#
