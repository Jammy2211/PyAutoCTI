...
data_name = 'ci_x8_images_non_uniform_high_res'

ci_data_name = []
ci_data_name.append('') # Task number beings at 1, so keep index 0 blank
ci_data_name.append(data_name+'/parallel_x3_species_model_4_1') # Index 1
ci_data_name.append(data_name+'/parallel_x3_species_model_4_2') # Index 2
ci_data_name.append(data_name+'/parallel_x3_species_model_4_3') # Index 3
ci_data_name.append(data_name+'/parallel_x3_species_model_5') # Index 4
ci_data_name.append(data_name+'/parallel_x3_species_model_6') # Index 5
ci_data_name.append(data_name+'/parallel_x3_species_model_7') # Index 6
...
pipeline = parallel_x3_species.make_pipeline(pipeline_path=ci_data_name[batch_id] + '/')
