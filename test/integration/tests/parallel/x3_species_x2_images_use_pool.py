...
def pipeline():
    ...
    data = list(map(lambda normalization :
                    simulation_util.load_test_ci_data(ci_data_type='ci_uniform', ci_data_model='parallel_x3',
...
def make_pipeline(test_name):
    ...
    phase1 = ParallelPhase(phase_name='phase_1', phase_folders=[test_type, test_name],
                           optimizer_class=af.MultiNest, parallel_species=[af.PriorModel(arctic_params.Species),
