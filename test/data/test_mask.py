...
class TestMaskRemoveRegions:
    ...
    def test__remove_one_region(self):
        ...
        mask = msk.Mask.create(shape=(3, 3), frame_geometry=cti_image.QuadGeometryEuclidBL(),
...
class TestMaskCosmicsBottomLeftGeometry:
    ...
    def test__mask_one_cosmic_ray_with_bigger_diagonal_mask(self):
        ...
        mask = msk.Mask.create(shape=(4, 4), frame_geometry=cti_image.QuadGeometryEuclidBL(),
...
class TestMaskCosmicsBottomRightGeometry:
    ...
    def test__mask_one_cosmic_ray_with_parallel_mask(self):
        ...
        mask = msk.Mask.create(shape=(3, 3), frame_geometry=cti_image.QuadGeometryEuclidBR(),
                                     ci_pattern=MockPattern(), cosmic_rays=cosmic_rays, cr_parallel=1)
    ...
    def test__mask_one_cosmic_ray_with_bigger_diagonal_mask(self):
        ...
        mask = msk.Mask.create(shape=(4, 4), frame_geometry=cti_image.QuadGeometryEuclidBR(),
                                     ci_pattern=MockPattern(), cosmic_rays=cosmic_rays, cr_diagonal=2)
...
class TestMaskCosmicsTopLeftGeometry:
    ...
    def test__mask_one_cosmic_ray_with_parallel_mask(self):
        ...
        mask = msk.Mask.create(shape=(3, 3), frame_geometry=cti_image.QuadGeometryEuclidTL(),
                                     ci_pattern=MockPattern(), cosmic_rays=cosmic_rays, cr_parallel=1)
    ...
    def test__mask_one_cosmic_ray_with_bigger_diagonal_mask(self):
        ...
        mask = msk.Mask.create(shape=(4, 4), frame_geometry=cti_image.QuadGeometryEuclidTL(),
                                     ci_pattern=MockPattern(), cosmic_rays=cosmic_rays, cr_diagonal=2)
...
class TestMaskCosmicsTopRightGeometry:
    ...
    def test__mask_one_cosmic_ray_with_parallel_mask(self):
        ...
        mask = msk.Mask.create(shape=(3, 3), frame_geometry=cti_image.QuadGeometryEuclidTR(),
                                     ci_pattern=MockPattern(), cosmic_rays=cosmic_rays, cr_parallel=1)
    ...
    def test__mask_one_cosmic_ray_with_bigger_diagonal_mask(self):
        ...
        mask = msk.Mask.create(shape=(4, 4), frame_geometry=cti_image.QuadGeometryEuclidTR(),
                                     ci_pattern=MockPattern(), cosmic_rays=cosmic_rays, cr_diagonal=2)
