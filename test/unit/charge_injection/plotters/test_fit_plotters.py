...
def test__image_line_is_output(fit, mask, fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_image_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                            output_path=fit_plotter_path, output_format='png')
...
def test__noise_map_line_is_output(fit, mask, fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_noise_map_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                                output_path=fit_plotter_path, output_format='png')
...
def test__signal_to_noise_map_line_is_output(fit, mask, fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_signal_to_noise_map_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                                          output_path=fit_plotter_path, output_format='png')
...
def test__ci_pre_cti_line_is_output(fit, mask, fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_ci_pre_cti_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                                 output_path=fit_plotter_path, output_format='png')
...
def test__ci_post_cti_line_is_output(fit, mask, fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_ci_post_cti_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                                  output_path=fit_plotter_path, output_format='png')
...
def test__residual_map_line_is_output(fit, mask,fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_residual_map_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                                   output_path=fit_plotter_path, output_format='png')
...
def test__chi_squared_map_line_is_output(fit, mask, fit_plotter_path, plot_patch):
    ...
    fit_plotters.plot_chi_squared_map_line(fit=fit, line_region='parallel_front_edge', mask=mask,
                                      output_path=fit_plotter_path, output_format='png')
