...
class TestPixelLineCollection:
    ...
    def test__generate_stacked_lines_from_bins(self):
        ...
        # Low row, low flux
        line_1 = PixelLine(data=[4, 3, 2], location=[0, 0], date=0, background=0)
        line_2 = PixelLine(data=[3, 2, 1], location=[1, 0], date=1, background=0)
        line_3 = PixelLine(data=[2, 1, 0], location=[2, 0], date=2, background=0)
        # Low row, high flux
        line_4 = PixelLine(data=[10, 8, 6], location=[3, 0], date=3, background=0)
        line_5 = PixelLine(data=[9, 7, 5], location=[4, 0], date=4, background=0)
        # Mid row, low flux
        line_6 = PixelLine(data=[3, 2, 1], location=[10, 0], date=5, background=0)
        line_7 = PixelLine(data=[2, 1, 0], location=[11, 0], date=6, background=0)
        line_8 = PixelLine(data=[1, 0, 0], location=[12, 0], date=7, background=0)
        # Mid row, high flux
        line_9 = PixelLine(data=[10, 9, 8], location=[10, 0], date=8, background=0)
        line_10 = PixelLine(data=[8, 8, 8], location=[11, 0], date=9, background=0)
        # High row, low flux
        line_11 = PixelLine(data=[3, 2, 1], location=[21, 0], date=10, background=0)
        line_12 = PixelLine(data=[0, 0, 0], location=[20, 0], date=11, background=0)
        # High row, high flux: no lines, empty bin
