...
# from autocti.autofit import model_mapper as model_mapper
...
#         initial_model = model_mapper.PriorModel(MockSpecies, test_config)
#         initial_model.trap_densities_0 = 1.
#         assert isinstance(initial_model.trap_densities_0, model_mapper.Constant)
#
#         new_model = initial_model.linked_model_for_class(MockSpecies)
#
#         assert new_model.trap_densities_0 is initial_model.trap_densities_0
#     #    assert new_model.trap_densities_1 is initial_model.trap_densities_1
#
#     def test_is_tuple_like_attribute_name(self):
#         assert model_mapper.is_tuple_like_attribute_name("trap_densities_0")
#         assert model_mapper.is_tuple_like_attribute_name("trap_densities_1")
#         assert not model_mapper.is_tuple_like_attribute_name("trap_densities")
#         assert model_mapper.is_tuple_like_attribute_name("trap_densities_why_not_0")
#         assert not model_mapper.is_tuple_like_attribute_name("trap_densities_why_not")
#
#     def test_tuple_name(self):
#         assert model_mapper.tuple_name("trap_densities_0") == "trap_densities"
#         assert model_mapper.tuple_name("trap_densities_1") == "trap_densities"
#         assert model_mapper.tuple_name("trap_densities_why_not_0") == "trap_densities_why_not"
#
#
...
#         one.a = model_mapper.PriorModel(arctic_params.ParallelOneSpecies)
#         two.b = model_mapper.PriorModel(arctic_params.ParallelOneSpecies)
#
#         three = one + two
#
#         assert three.prior_count == 12
#
#
...
# #         mapper.species = arctic_params.ParallelOneSpecies
# #         info = mapper.info
# #
# #         mapper.profile.trap_densities_0 = 1.
# #
# #         assert len(mapper.profile.trap_densities.constant_tuples) == 1
...
# #         mm.galaxy = galaxy_model.GalaxyModel(sersic=arctic_params.ParallelOneSpecies)
# #
# #         assert mm.prior_count == 7
# #
# #         mm.galaxy.sersic.trap_densities_0 = model_mapper.Constant(0)
# #         mm.galaxy.sersic.trap_densities_1 = model_mapper.Constant(0)
# #
...
# #         mm.galaxy = galaxy_model.GalaxyModel(sersic=arctic_params.ParallelOneSpecies)
# #
# #         assert isinstance(mm.galaxy.sersic.trap_densities_0, mm.Prior)
# #         assert isinstance(mm.galaxy.sersic.trap_densities_1, mm.Prior)
# #
...
#         mapper = model_mapper.ModelMapper(MockConfig())
#
#         mapper.mock_species = MockSpecies
#
