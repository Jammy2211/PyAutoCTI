...
def test__median_list_of_lists_from__pixels_from_end(
    ...
    median_list_of_lists = extract.median_list_of_lists_from(
        array=parallel_array, pixels_from_end=3
    )
    assert median_list_of_lists[0] == [2.0, 2.0, 2.0]
    ...
    median_list_of_lists = extract.median_list_of_lists_from(
        array=parallel_array, pixels_from_end=1
    )
    ...
    median_list_of_lists = extract.median_list_of_lists_from(
        array=parallel_array, pixels_from_end=2
    )
...
def test__std_list_from(parallel_array, parallel_masked_array):
    ...
    std_list = extract.std_list_from(array=parallel_array, pixels=(0, 3))
    ...
    std_list = extract.std_list_from(array=parallel_masked_array, pixels=(0, 3))
