...
def test__individual_attributes_are_output(dataset_line_7, plot_path, plot_patch):
    ...
    dataset_line_plotter.figures_1d(
        line=True, noise_map=True, pre_cti_line=True, signal_to_noise_map=True
    )

    assert path.join(plot_path, "line.png") in plot_patch.paths
    ...
    dataset_line_plotter.figures_1d(line=True, pre_cti_line=True)
