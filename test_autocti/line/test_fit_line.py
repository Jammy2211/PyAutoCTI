...
#     def test__image_and_post_cti_line_the_same__noise_scaling_all_0s__likelihood_is_noise_normalization(
#         self, layout_ci_7x7
#     ):
#
#         image = 10.0 * ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#         noise_map = ac.Array1D.full(
#             fill_value=2.0, shape_native=(2, 2), pixel_scales=1.0
#         )
#         pre_cti_image = 10.0 * ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#
#         noise_scaling_map_list = [
#             ac.Array1D.zeros(shape_native=(2, 2), pixel_scales=1.0),
#             ac.Array1D.zeros(shape_native=(2, 2), pixel_scales=1.0),
#         ]
#
...
#
#         fit = ac.FitDatasetLine(
#             dataset_line=masked_imaging,
#             post_cti_line=masked_imaging.pre_cti_image,
...
#         self, layout_ci_7x7
#     ):
#         image = ac.Array1D.full(fill_value=9.0, shape_native=(2, 2), pixel_scales=1.0)
#         noise_map = ac.Array1D.full(
#             fill_value=2.0, shape_native=(2, 2), pixel_scales=1.0
#         )
#         pre_cti_image = ac.Array1D.full(
#             fill_value=10.0, shape_native=(2, 2), pixel_scales=1.0
#         )
#
#         noise_scaling_map_list = [
#             ac.Array1D.manual(array=[[0.0, 0.0], [0.0, 0.0]], pixel_scales=1.0)
#         ]
#
#         imaging = ac.ci.ImagingCI(
#             image=image,
...
#         )
#
#     def test__image_and_post_cti_line_the_same__noise_scaling_non_0s__likelihood_is_noise_normalization(
#         self, layout_ci_7x7
#     ):
#         image = 10.0 * ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#         noise_map = ac.Array1D.full(
...
#
#         noise_scaling_map_list = [
#             ac.Array1D.manual(array=[[1.0, 2.0], [3.0, 4.0]], pixel_scales=1.0),
#             ac.Array1D.manual(array=[[5.0, 6.0], [7.0, 8.0]], pixel_scales=1.0),
#         ]
#
#         imaging = ac.ci.ImagingCI(
#             image=image,
...
#     ):
#         image = 10.0 * ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#         noise_map = 3.0 * ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#         pre_cti_image = ac.Array1D.full(
#             fill_value=10.0, shape_native=(2, 2), pixel_scales=1.0
#         )
#
...
#         self, dataset_line_7, layout_ci_7x7, mask_1d_7_unmasked
#     ):
#
#         masked_dataset_line_7 = dataset_line_7.apply_mask(mask=mask_1d_7_unmasked)
#
...
#
#         fit = ac.FitDatasetLine(
#             dataset_line=masked_dataset_line_7,
#             post_cti_line=masked_dataset_line_7.pre_cti_image,
#             hyper_noise_scalars=[hyper_noise_scalar_0, hyper_noise_scalar_1],
#         )
#
#         hyper_noise_map = hyper_noise_map_from_noise_map_and_noise_scalings(
#             noise_map=masked_dataset_line_7.noise_map,
#             noise_scaling_map_list=masked_dataset_line_7.noise_scaling_map_list,
#             hyper_noise_scalars=[hyper_noise_scalar_0, hyper_noise_scalar_1],
#         )
#
...
#             data=masked_dataset_line_7.data,
#             mask=mask_1d_7_unmasked,
#             model_data=masked_dataset_line_7.pre_cti_image,
#         )
#
...
#
#         noise_normalization = ac.util.fit.noise_normalization_with_mask_from(
#             noise_map=hyper_noise_map, mask=mask_1d_7_unmasked
#         )
#
#         log_likelihood = ac.util.fit.log_likelihood_from(
#             chi_squared=chi_squared, noise_normalization=noise_normalization
...
#         )
#
#         image = 3.0 * ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#         noise_map = ac.Array1D.ones(shape_native=(2, 2), pixel_scales=1.0)
#         pre_cti_image = ac.Array1D.full(
#             fill_value=1.0, shape_native=(2, 2), pixel_scales=1.0
#         ).native
#
#         imaging = ac.ci.ImagingCI(
#             image=image, noise_map=noise_map, pre_cti_image=pre_cti_image, layout=layout
#         )
#
#         mask = ac.Mask2D.unmasked(shape_native=(2, 2), pixel_scales=1.0)
#
#         masked_imaging = imaging.apply_mask(mask=mask)
#
#         fit = ac.FitDatasetLine(dataset_line=masked_imaging, post_cti_line=pre_cti_image)
#
#         assert (
